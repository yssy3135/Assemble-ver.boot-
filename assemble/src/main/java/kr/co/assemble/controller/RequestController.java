...
import kr.co.assemble.repository.RequestDAO;
...
//      model.addAttribute("groupno", groupno);   
   ...
   public String myreq(HttpSession session, Model model) {
      ...
      return "forward:/assemble.io/"+assemblename+"/header/myRequest";
   ...
   public String myReqStatus(
	   ...
	   url = "forward:/assemble.io/"+assemblename+"/header/status0";
